...
def is_relevant_flashcard(question: str, answer: str) -> bool:
    ...
    """
    # Ensure the question and answer are not too vague, irrelevant, or time-dependent.
    if not question or not answer:
        return False

    irrelevant_keywords = ["farm animals", "cardinal directions", "first mentioned", "timestamp", "specific event"]
